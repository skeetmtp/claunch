...
URL scheme handler for Claude Code CLI. Click a `claunch://` link in your browser, Slack, or docs and it opens a Ghostty terminal window running `claude` with the prompt from the URL.
